...
from cadet.models.graphsmote import AblationSMOTE
...
class CadModelLightning(LightningModule):
    def __init__(self,
        ...
        self.module = AblationSMOTE(in_feats, n_hidden, n_classes, n_layers, activation, dropout, ext_mode=ext_mode, adj_thresh=adj_thresh)
        self.lr = lr
    ...
    def validation_step(self, batch, batch_idx):
        ...
        batch_pred = self.module.classifier(batch_pred)
